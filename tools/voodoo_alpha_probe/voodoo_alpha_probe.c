...
app_main(void)
{
    ...
    draw_alpha_case_full(GR_BLEND_SATURATE, GR_BLEND_ONE, GR_BLEND_ZERO,
                         "SATURATE/ZERO", AUX_ALPHA_NONE);
    ...
    draw_alpha_case_full(GR_BLEND_SRC_ALPHA, GR_BLEND_ZERO, GR_BLEND_ZERO,
                         "AUX_ALPHA_ENABLE_ATTEMPT_NODEPTH_ALPHA_OUT_NEITHER", AUX_ALPHA_NODEPTH_COLOR_ALPHA);
    ...
    draw_alpha_case_full(GR_BLEND_SRC_ALPHA, GR_BLEND_ONE, GR_BLEND_ZERO,
                         "AUX_ALPHA_ENABLE_ATTEMPT_NODEPTH_SRC_ALPHA_OUT", AUX_ALPHA_NODEPTH_COLOR_ALPHA);
    draw_alpha_case_full(GR_BLEND_SRC_ALPHA, GR_BLEND_ONE, GR_BLEND_ONE,
                         "AUX_ALPHA_ENABLE_ATTEMPT_NODEPTH_ALPHA_OUT_BOTH", AUX_ALPHA_NODEPTH_COLOR_ALPHA);

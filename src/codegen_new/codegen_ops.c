...
/*a0*/  ropMOV_AL_abs,  ropMOV_AX_abs,  ropMOV_abs_AL,  ropMOV_abs_AX,  ropMOVSB,       ropMOVSW,       ropCMPSB,       ropCMPSW,       ropTEST_AL_imm, ropTEST_AX_imm, ropSTOSB,       ropSTOSW,       ropLODSB,       ropLODSW,       NULL,           NULL,
...
/*a0*/  ropMOV_AL_abs,  ropMOV_EAX_abs, ropMOV_abs_AL,  ropMOV_abs_EAX, ropMOVSB,       ropMOVSL,       ropCMPSB,       ropCMPSL,       ropTEST_AL_imm, ropTEST_EAX_imm,ropSTOSB,       ropSTOSL,       ropLODSB,       ropLODSL,       NULL,           NULL,

...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[ATA-3] Samsung Winner 5X",                        .internal_name = "WU33205A",     .model = "SAMSUNG WU33205A",                                            .zones =  6, .avg_spt = 200, .heads =  4, .rpm = 5400, .full_stroke_ms = 20, .track_seek_ms = 3,   .rcache_num_seg =  8, .rcache_seg_size =  128, .max_multiple = 16 },

...
A013_TRACE_EFFECTIVE="$(printenv 86BOX_A013_TRACE 2>/dev/null || true)"

if [ -z "${A013_TRACE_EFFECTIVE}" ]; then
    A013_TRACE_EFFECTIVE=0
fi
...
env_86BOX_3DNOW_COV_STATS=$(env_or_unset 86BOX_3DNOW_COV_STATS)
env_86BOX_A013_TRACE_EFFECTIVE=${A013_TRACE_EFFECTIVE}
